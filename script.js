document.addEventListener('DOMContentLoaded', function() {
	...
	.then(data => {
		...
		const attributes = ['eyeColor', 'female', 'hat', 'speaking', 'smoking', 'noFace', 'demon', 'threePlusEye', 'lines', 'earphone', 'music', 'hands', 'ghost', 'emoji', 'crown', 'oneEye', 'sick', 'animal', 'alien', 'weapon', 'ape', 'openScalp', 'miner', 'shadow', 'lfg', 'clown', 'hoodie', 'OGHoodies', 'famous', 'letterhead', 'glasses', 'robot', 'punk', 'undead', 'mask', 'gasMask'];
